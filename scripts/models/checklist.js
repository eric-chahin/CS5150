...
var Checklist = function(version) {
  ...
  this.createChecklistHTML = function() {
    ...
    $(checklistclass).append("<div class='vector-content'><h3>Vector</h5>"
                         +"<div class='vector-row'>Vector 1:<select type='text' name='vector1' id='vector1'><option selected disabled>Select Vector</option></select> Completed? <input type='checkbox' name='completedVec1' id='completedVec1' value='tech'><div class='vector-warning'></div></div>"
