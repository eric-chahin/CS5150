...
$("#new").mousedown(function(){
  $("#new").css("background-image", "url(img/sidebar/icon_new_selected.png)");
})
...
$("#load").mousedown(function(){
  $("#load").css("background-image", "url(img/sidebar/icon_load_selected.png)");
})
...
$("#save").mousedown(function(){
  $("#save").css("background-image", "url(img/sidebar/icon_save_selected.png)");
})
...
$("#print").mousedown(function(){
  $("#print").css("background-image", "url(img/sidebar/icon_print_selected.png)");
})
...
$("#addsemesterimage").mousedown(function(){
   if (user.current_schedule.numSemesters < 9) {
        //$("#addsemesterimage").css("background-image", "url(img/icon_add_selected.png");
         $("#addsemesterimage").css("background-image", "url(img/icon_subtract.png)");
        ...
        //$("#addsemesterimage").css("background-image", "url(img/icon_subtract_selected.png");
        $("#addsemesterimage").css("background-image", "url(img/icon_add.png)");
