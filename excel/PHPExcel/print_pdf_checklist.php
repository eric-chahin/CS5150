...
$_POST['version'] = "2012";
$users_name = "Eric Chahin";//$_POST['name'];
$netid = "erc73";//$_POST['netid'];
...
if (!file_exists($version_checklist)) {
  exit("The checklist you are looking for, ".$version_checklist.", does not exist. Please contact the system admin." . EOL);
}
...
$objPHPExcel->getActiveSheet()->setCellValue('A8',"Hellossss");
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle($netid.'_checklist');
...
header('Content-Disposition: attachment;filename="'.$netid.'_checklist'.'"');
